...
BOOST_AUTO_TEST_CASE(test_join_ct){
	...
	BOOST_TEST((rt_id(m5) == id< std_matrix< int, 3_C, 3_R > >));
	BOOST_TEST((rt_id(m6) == id< std_matrix< int, 3_C, 3_R > >));
	BOOST_TEST((rt_id(m7) == id< std_matrix< int, 6_C, 6_R > >));
...
BOOST_AUTO_TEST_CASE(test_join_rt){
	...
	BOOST_TEST((rt_id(m5) == id< std_matrix< int, 0_C, 0_R > >));
	BOOST_TEST((rt_id(m6) == id< std_matrix< int, 0_C, 0_R > >));
	BOOST_TEST((rt_id(m7) == id< std_matrix< int, 0_C, 0_R > >));
...
BOOST_AUTO_TEST_CASE(test_join_ct_and_rt_2){
	...
	BOOST_TEST((rt_id(m5) == id< std_matrix< int, 0_C, 3_R > >));
	BOOST_TEST((rt_id(m6) == id< std_matrix< int, 3_C, 0_R > >));
	BOOST_TEST((rt_id(m7) == id< std_matrix< int, 0_C, 6_R > >));
