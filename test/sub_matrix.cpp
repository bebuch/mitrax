...
BOOST_AUTO_TEST_CASE(test_sub_matrix_3x3){
	...
	BOOST_TEST(check1(sub_matrix(m, point_t(0, 0), 2_C_rt, 2_R)));
	BOOST_TEST(check2(sub_matrix(m, point_t(1, 0), 2_C_rt, 2_R)));
	BOOST_TEST(check3(sub_matrix(m, point_t(0, 1), 2_C_rt, 2_R)));
	BOOST_TEST(check4(sub_matrix(m, point_t(1, 1), 2_C_rt, 2_R)));

	BOOST_TEST(check1(sub_matrix(m, point_t(0, 0), 2_C, 2_R_rt)));
	BOOST_TEST(check2(sub_matrix(m, point_t(1, 0), 2_C, 2_R_rt)));
	BOOST_TEST(check3(sub_matrix(m, point_t(0, 1), 2_C, 2_R_rt)));
	BOOST_TEST(check4(sub_matrix(m, point_t(1, 1), 2_C, 2_R_rt)));

	BOOST_TEST(check1(sub_matrix(m, point_t(0, 0), 2_C_rt, 2_R_rt)));
	BOOST_TEST(check2(sub_matrix(m, point_t(1, 0), 2_C_rt, 2_R_rt)));
	BOOST_TEST(check3(sub_matrix(m, point_t(0, 1), 2_C_rt, 2_R_rt)));
	...
	BOOST_TEST(check1(sub_matrix(m, point_t(0, 0), dims(2_C_rt, 2_R))));
	BOOST_TEST(check2(sub_matrix(m, point_t(1, 0), dims(2_C_rt, 2_R))));
	BOOST_TEST(check3(sub_matrix(m, point_t(0, 1), dims(2_C_rt, 2_R))));
	BOOST_TEST(check4(sub_matrix(m, point_t(1, 1), dims(2_C_rt, 2_R))));

	BOOST_TEST(check1(sub_matrix(m, point_t(0, 0), dims(2_C, 2_R_rt))));
	BOOST_TEST(check2(sub_matrix(m, point_t(1, 0), dims(2_C, 2_R_rt))));
	BOOST_TEST(check3(sub_matrix(m, point_t(0, 1), dims(2_C, 2_R_rt))));
	BOOST_TEST(check4(sub_matrix(m, point_t(1, 1), dims(2_C, 2_R_rt))));

	BOOST_TEST(check1(sub_matrix(m, point_t(0, 0), dims(2_C_rt, 2_R_rt))));
	BOOST_TEST(check2(sub_matrix(m, point_t(1, 0), dims(2_C_rt, 2_R_rt))));
	BOOST_TEST(check3(sub_matrix(m, point_t(0, 1), dims(2_C_rt, 2_R_rt))));
	BOOST_TEST(check4(sub_matrix(m, point_t(1, 1), dims(2_C_rt, 2_R_rt))));
}
