...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_view_matrix_3x3, T, types){
	...
	auto m05 = make_view_matrix(dim_pair(3_c, 3_r), init_ca);
	auto m06 = make_view_matrix(dim_pair(3_cd, 3_r), init_ca);
	auto m07 = make_view_matrix(dim_pair(3_c, 3_rd), init_ca);
	...
	auto m11 = make_view_matrix(dim_pair(3_d), init_ca);
	...
	auto m17 = make_view_matrix(dim_pair(3_c, 3_r), init_a);
	auto m18 = make_view_matrix(dim_pair(3_cd, 3_r), init_a);
	auto m19 = make_view_matrix(dim_pair(3_c, 3_rd), init_a);
	...
	auto m23 = make_view_matrix(dim_pair(3_d), init_a);
	...
	auto m29 = make_view_matrix(dim_pair(3_c, 3_r), init_v);
	auto m30 = make_view_matrix(dim_pair(3_cd, 3_r), init_v);
	auto m31 = make_view_matrix(dim_pair(3_c, 3_rd), init_v);
	...
	auto m35 = make_view_matrix(dim_pair(3_d), init_v);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_view_matrix_3x3_const, T, types){
	...
	constexpr auto m05 = make_const_view_matrix(dim_pair(3_c, 3_r), init_ca);
	auto m06 = make_const_view_matrix(dim_pair(3_cd, 3_r), init_ca);
	auto m07 = make_const_view_matrix(dim_pair(3_c, 3_rd), init_ca);
	...
	constexpr auto m11 = make_const_view_matrix(dim_pair(3_d), init_ca);
	...
	auto m17 = make_const_view_matrix(dim_pair(3_c, 3_r), init_a);
	auto m18 = make_const_view_matrix(dim_pair(3_cd, 3_r), init_a);
	auto m19 = make_const_view_matrix(dim_pair(3_c, 3_rd), init_a);
	...
	auto m23 = make_const_view_matrix(dim_pair(3_d), init_a);
	...
	auto m29 = make_const_view_matrix(dim_pair(3_c, 3_r), init_v);
	auto m30 = make_const_view_matrix(dim_pair(3_cd, 3_r), init_v);
	auto m31 = make_const_view_matrix(dim_pair(3_c, 3_rd), init_v);
	...
	auto m35 = make_const_view_matrix(dim_pair(3_d), init_v);
