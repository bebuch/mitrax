...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_view_matrix_3x3_const, T, types){
	...
	auto m02 = make_const_view_matrix(3_C_rt, 3_R, init_ca);
	auto m03 = make_const_view_matrix(3_C, 3_R_rt, init_ca);
	auto m04 = make_const_view_matrix(3_C_rt, 3_R_rt, init_ca);
	constexpr auto m05 = make_const_view_matrix(dims(3_C, 3_R), init_ca);
	auto m06 = make_const_view_matrix(dims(3_C_rt, 3_R), init_ca);
	auto m07 = make_const_view_matrix(dims(3_C, 3_R_rt), init_ca);
	auto m08 = make_const_view_matrix(dims(3_C_rt, 3_R_rt), init_ca);
	constexpr auto m09 = make_const_view_matrix(3_D, init_ca);
	auto m10 = make_const_view_matrix(3_D_rt, init_ca);
	constexpr auto m11 = make_const_view_matrix(dims(3_D), init_ca);
	auto m12 = make_const_view_matrix(dims(3_D_rt), init_ca);

	auto m13 = make_const_view_matrix(3_C, 3_R, init_a);
	auto m14 = make_const_view_matrix(3_C_rt, 3_R, init_a);
	auto m15 = make_const_view_matrix(3_C, 3_R_rt, init_a);
	auto m16 = make_const_view_matrix(3_C_rt, 3_R_rt, init_a);
	auto m17 = make_const_view_matrix(dims(3_C, 3_R), init_a);
	auto m18 = make_const_view_matrix(dims(3_C_rt, 3_R), init_a);
	auto m19 = make_const_view_matrix(dims(3_C, 3_R_rt), init_a);
	auto m20 = make_const_view_matrix(dims(3_C_rt, 3_R_rt), init_a);
	auto m21 = make_const_view_matrix(3_D, init_a);
	auto m22 = make_const_view_matrix(3_D_rt, init_a);
	auto m23 = make_const_view_matrix(dims(3_D), init_a);
	auto m24 = make_const_view_matrix(dims(3_D_rt), init_a);

	auto m25 = make_const_view_matrix(3_C, 3_R, init_v);
	auto m26 = make_const_view_matrix(3_C_rt, 3_R, init_v);
	auto m27 = make_const_view_matrix(3_C, 3_R_rt, init_v);
	auto m28 = make_const_view_matrix(3_C_rt, 3_R_rt, init_v);
	auto m29 = make_const_view_matrix(dims(3_C, 3_R), init_v);
	auto m30 = make_const_view_matrix(dims(3_C_rt, 3_R), init_v);
	auto m31 = make_const_view_matrix(dims(3_C, 3_R_rt), init_v);
	auto m32 = make_const_view_matrix(dims(3_C_rt, 3_R_rt), init_v);
	auto m33 = make_const_view_matrix(3_D, init_v);
	auto m34 = make_const_view_matrix(3_D_rt, init_v);
	auto m35 = make_const_view_matrix(dims(3_D), init_v);
	auto m36 = make_const_view_matrix(dims(3_D_rt), init_v);
