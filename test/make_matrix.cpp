...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_raw_matrix_1x3, T, types){
	...
	auto m02 = make_col_vector_v< T >(3_R);
	auto m03 = make_matrix_v< T >(1_C, 3_R_rt);
	auto m04 = make_col_vector_v< T >(3_R_rt);
	...
	auto m08 = make_col_vector_v(3_R, T(7));
	auto m09 = make_matrix_v(1_C, 3_R_rt, T(7));
	auto m10 = make_col_vector_v(3_R_rt, T(7));
	...
	auto m14 = make_col_vector< T >(3_R, {0, 1, 2});
	auto m15 = make_matrix< T >(1_C, 3_R_rt, {{0}, {1}, {2}});
	auto m16 = make_col_vector< T >(3_R_rt, {0, 1, 2});
...
BOOST_AUTO_TEST_CASE_TEMPLATE(test_raw_matrix_3x1, T, types){
	...
	auto m02 = make_row_vector_v< T >(3_C);
	auto m03 = make_matrix_v< T >(3_C_rt, 1_R);
	auto m04 = make_row_vector_v< T >(3_C_rt);
	...
	auto m08 = make_row_vector_v(3_C, T(7));
	auto m09 = make_matrix_v(3_C_rt, 1_R, T(7));
	auto m10 = make_row_vector_v(3_C_rt, T(7));
	...
	auto m14 = make_row_vector< T >(3_C, {0, 1, 2});
	auto m15 = make_matrix< T >(3_C_rt, 1_R, {{0, 1, 2}});
	auto m16 = make_row_vector< T >(3_C_rt, {0, 1, 2});
