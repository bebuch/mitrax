...
BOOST_AUTO_TEST_CASE(test_raw_bitmap){
	auto m01 = make_bitmap< int >(2, 3);
	auto m02 = make_bitmap< int >(3, 2);
	auto m03 = make_bitmap< int >(dims(2, 3));
	auto m04 = make_bitmap< int >(dims(3, 2));

	auto m05 = make_bitmap(2, 3, 7);
	auto m06 = make_bitmap(3, 2, 7);
	auto m07 = make_bitmap(dims(2, 3), 7);
	auto m08 = make_bitmap(dims(3, 2), 7);
