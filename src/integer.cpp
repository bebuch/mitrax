...
BOOST_AUTO_TEST_CASE(test_int_to_size_t){
	...
	BOOST_TEST((dim_init< true, true, 14 >()).col() == size_t(14));
	BOOST_TEST((dim_init< true, false, 14 >()).col() == size_t(14));
	BOOST_TEST((dim_init< true, true, 14 >()).row() == size_t(14));
	BOOST_TEST((dim_init< true, false, 14 >()).row() == size_t(14));
