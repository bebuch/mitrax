...
namespace mitrax{
	...
	class dims_t{
	public:
		constexpr dims_t(col_t< C > cols, row_t< R > rows)noexcept:
	...
	constexpr auto dims(
		...
		return dims_t< dim(Cct, C), dim(Rct, R) >(c.get(), r.get());
	}
